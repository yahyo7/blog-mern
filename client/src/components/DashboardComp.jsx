      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={`/dashboard?tab=users`}>See all users</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={`/dashboard?tab=comments`}>See all comments</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={`/dashboard?tab=users`}>See all posts</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
                  ...
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    <Table.Cell>
                      <img
                        src={post.image}
                        alt={post.slug}
                        className="w-15 h-10 bg-gray-500"
                      />
                    </Table.Cell>
